...
-- Author: Alexander Bichalho

macroScript RAM_Render
    category:"Tools"
    toolTip:"Render to Ram"
(
    local r_dialogue
    ...
    (
        ...
        (
            ...
            spinner aspect "Ascpect" fieldwidth:60 pos:[10,p+56] type:#float range:[0,20,1.0]
            button s160 "160x120" pos:[125,p+06] width:75 height:19
            button s256 "256x243" pos:[125,p+06] width:75 height:19
            button s320 "320x240" pos:[125,p+06] width:75 height:19
            button s512 "512x486" pos:[125,p+06] width:75 height:19
            button s640 "640x480" pos:[125,p+06] width:75 height:19
            button s720 "720x486" pos:[125,p+06] width:75 height:19
